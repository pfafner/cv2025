...
08       | 04.02.2025   | Morfología matemática: *dilation*, *erosion*, *opening*, *closing*, *Top-Hat*. | [circles.png](code/circles.png){:target="_blank"} [Cosmos_original.jpeg](code/Cosmos_original.jpeg){:target="_blank"} <br/> [morphology1.ipynb](code/morphology1.ipynb){:target="_blank"}
...
L3       | 25.03.2025   | Construcción de un HoG. <br/> [Lab 03](labs/lab03.pdf){:target="_blank"} | **Fecha de Entrega: 01 de abril.** 
